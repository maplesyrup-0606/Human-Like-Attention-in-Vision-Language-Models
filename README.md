...
In [scripts](#scripts), you can create scanpaths for your dataset of interest by running the script `HAT.sh`.
...
### 7. LLM-as-a-judge
---
In this project, LLMs were used as a judge to 1) evaluate caption quality, 2) Measure attribute count (**CUB**). 
