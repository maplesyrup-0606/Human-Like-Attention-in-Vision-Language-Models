...
python -m llava.serve.cli \
 ...
 --load-4bit \
 --image-file ~/NSERC/images_captions_for_test/COCO_train2014_000000513461.jpg \
 --scanpath ~/NSERC/images_captions_for_test_scanned/scanpaths/COCO_train2014_000000513461_scanpath.npy
